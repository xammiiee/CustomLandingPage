...
<div class="modal fade" id="signinPage">
  ...
  <!--==========================
    Intro Section
  ============================-->
  <section id="introresult" class="clearfix">
    <div class="container">
  ...
  <main id="main">
    ...
    <!----------------------- search result display table ------------------------------>
        <div class="row">
          <div class="col-md-3 col-lg-10 offset-lg-1 wow bounceInUp" data-wow-duration="1.4s">
            
            <div class="box">
              <h4 class="title"><a href=""><span id="resulttitle">Title of Research</span></a></h4>
              <ul class="list-inline" style="padding-left: 40px;"><i>
                <li class="list-inline-item"><a href=""><span>Author</a></span></li>
                <li class="list-inline-item"><span>Field of study</span></li>
                <li class="list-inline-item"><span>Date published</span></li>
              </i></ul>
              <p class="description"> <span id="resultabstract">Voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident</span></p>
              <ul class="list-inline" style="padding-left: 40px;">
                <li class="list-inline-item"><a href="##"><span>Views</a></span></li>
                <li class="list-inline-item"><a href="##"><span>Cites</a></span></li>
