                ...
                <table class="table table-striped table-hover table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>Headlines <i class="fa fa-sort"></i></th>
                            <th>Description</th>
                    ...
                    <?php
                         ...
                         if(mysqli_num_rows($result) > 0) {
                             ...
                             foreach($account as $user_data) : ?>

                        <tr>
                     
                            <td><?php echo $user_data['name']; ?></td>   <!-- HEADLINES DATA -->
                            <td><?php echo $user_data['mobile']; ?> </td> <!-- DESCRIPTION DATA -->
                            <td><?php echo $user_data['email']; ?> </td> <!-- DATE CREATED -->
                            
                            <td>
                                <a href="#" class="view" title="View" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                                <a href="edit.php?id=<?php echo $user_data['id'];?>" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
