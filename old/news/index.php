  ...
  <header id="header" class="fixed-top">
    <div class="container">
      ...
      <nav class="main-nav float-right d-none d-lg-block">
        <ul>
          <li class="active"><a href="./index.php">News Management</a></li>
          <li class="active"><a href="/customlandingpage/events/index.php">Events Management</a></li>
  ...
  <br>
    ...
    <tr>
      <td>
          ...
          <a href="add.php"  name="uploadingresearch"> 
                <button type="button" class="btn btn-primary"  name="uploadingresearch">
              Add News
               </button>
          </a> 
...
while($user_data = mysqli_fetch_array($result)) {       
    ...
    echo "<td>
      ...
      <a href='view.php?id=$user_data[id]' <button type='button' class='btn btn-info btn-sm'></button> View </a>
      <a href='edit.php?id=$user_data[id]' <button type='button' class='btn btn-warning btn-sm'></button> Edit </a>
      <a href='delete.php?id=$user_data[id]' <button type='button' class='btn btn-danger btn-sm'></button> Delete </a>
    </td>
