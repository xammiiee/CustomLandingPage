...
<a href="journal.php"><button type="button" class="btn btn-outline-dark btn-md">
  Refresh
</button>
</a>
   ...
   <tbody>
     ...
     while ($data = mysqli_fetch_array($result)) {
       ...
       <tr>
         ...
         <td><a href="api/project.php?id=<?php echo $data['id']?>&ref=projects"><?php echo $data['author']?></a></td>
